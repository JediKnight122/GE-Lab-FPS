...
namespace Character
{
	...
	public sealed class CharacterPlayer : CharacterBehaviour
	{
		...
		/// <summary>
		/// Checks if the player is able to crouch
		/// </summary>
		/// <returns>true if is able to crouch</returns>
		private bool CanCrouch()
		{
			//LOGIK FÜR IN DER LUFT
